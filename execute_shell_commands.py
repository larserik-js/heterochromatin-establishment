...
os.system(f"python3 main.py --n_processes=11 --pool_size=25 --multiprocessing_parameter=U_pressure_weight --test_mode=0 "
          + f"--write_cenH_data=0 --animate=0 --allow_state_change=0 --t_total={t_total} --stats_t_interval=100 "
