...
def create_param_filename(initial_state, cenH_size, cell_division, barriers, N, t_total, noise, alpha_1, alpha_2, beta, seed):
    ...
    param_string += f'cenH={cenH_size}_N={N}_t_total={t_total}_noise={noise:.4f}_alpha_1={alpha_1:.5f}_alpha_2={alpha_2:.5f}' \
