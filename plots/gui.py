...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        # initialize data
        self.plot_type = ('Correlations', 'Correlation times',
                          'End-to-end distances', 'End-to-end times',
                          'Establishment times and silent patches',
                          'Final state', 'Fractions of "ON" cells', 'Heatmap',
                          'Monomer interactions', 'Monomer states',
                          'Monomer states (time-space plot)', 'Optimization',
                          'Optimization result', 'RMS',
                          'Successful recruited conversions', 'Time dynamics')

        self.parameters = ('model', 'n_processes', 'rms', 'cenH_size',
                           'cenH_init_idx', 'ATF1_idx', 'N', 't_total', 'noise',
                           'initial_state', 'dt', 'alpha_1', 'alpha_2', 'beta',
                           'seed', 'cell_division')
        ...
        self.prefill_params = ('CMOL', 1, 2.0, 8, 15, None, 40, 100000, 0.5,
    ...
    def create_widget(self):
        ...
        option_menu = ttk.OptionMenu(self, self.option_var, self.plot_type[10],
                                     *self.plot_type, command=None)
        option_menu.grid(column=1, row=0, sticky=tk.W, **paddings)

        # Entry fields
        entry_label = ttk.Label(self, text='Parameters:', font=headline_font)
