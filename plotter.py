...
plot_obj = Plots(model=plot_model, n_processes=plot_n_processes, U_pressure_weight=plot_U_pressure_weight,
                 stats_interval=plot_stats_interval, cenH_size=plot_cenH_size, cenH_sizes=plot_cenH_sizes,
                 cenH_init_idx=plot_cenH_init_idx, ATF1_idx=plot_ATF1_idx, cell_division=plot_cell_division, N=plot_N,
                 t_total=plot_t_total, noise=plot_noise, initial_state=plot_initial_state, alpha_1=plot_alpha_1,
                 alpha_2=plot_alpha_2, beta=plot_beta, seed=plot_seed)
